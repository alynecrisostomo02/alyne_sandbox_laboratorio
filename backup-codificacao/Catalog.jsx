...
export default function Catalog({ favorites, onFavorite, query }) {
  ...
  const filtered = useMemo(() => {
    const result = visibleProperties.filter((property) => {
      ...
      if (filters.gourmet && !property.features.includes("Ãrea gourmet")) return false;
      if (filters.solar && !property.features.includes("Energia solar")) return false;
      if (filters.planned && !property.features.includes("MÃ³veis planejados")) return false;
    ...
    <main className="catalog-page">
      <section className="page-banner">
        <div className="container">
          <p className="eyebrow">CatÃ¡logo imobiliÃ¡rio</p>
          <h1>ImÃ³veis em RedenÃ§Ã£o</h1>
          <p>Explore as opÃ§Ãµes e ajuste os filtros de acordo com o que vocÃª procura.</p>
          <p className="demo-note light-note">
            VersÃ£o demonstrativa: imÃ³veis, valores e condiÃ§Ãµes estÃ£o em validaÃ§Ã£o. Confirme tudo antes de qualquer decisÃ£o.
          </p>
        </div>
      </section>
      ...
      <section className="section catalog-section">
        <div className="container catalog-layout">
          <aside className={`filters-panel ${filtersOpen ? "is-open" : ""}`} aria-label="Filtros de imÃ³veis">
            <div className="filters-title">
              <div>
                <h2>Filtrar imÃ³veis</h2>
            ...
            <div className="field">
              <label htmlFor="filter-type">Tipo do imÃ³vel</label>
            ...
            <div className="field">
              <label htmlFor="filter-neighborhood">Bairro ou condomÃ­nio</label>
            ...
            <fieldset>
              ...
              <div className="two-fields">
                <div>
                  <label htmlFor="min-price">MÃ­nimo (R$)</label>
                ...
                <div>
                  <label htmlFor="max-price">MÃ¡ximo (R$)</label>
            ...
            <fieldset className="checkbox-group">
              ...
              {[
                ["piscina", "Piscina"],
                ["gourmet", "Ãrea gourmet"],
                ["solar", "Energia solar"],
                ["planned", "MÃ³veis planejados"],
                ["furnished", "Mobiliado"],
                ["financeable", "FinanciÃ¡vel"],
              ].map(([field, label]) => (
                <label key={field}>
          ...
          <div className="catalog-results">
            <div className="results-toolbar">
              <div>
                ...
                <p aria-live="polite">
                  <strong>{filtered.length}</strong> {filtered.length === 1 ? "imÃ³vel encontrado" : "imÃ³veis encontrados"}
                </p>
              </div>
            ...
            {filtered.length > 0 ? (
              ...
              <div className="empty-state">
                ...
                <h2>Nenhum imÃ³vel encontrado</h2>
                <p>Tente remover alguns filtros ou conte o que vocÃª procura para nossa equipe.</p>
                <div>
