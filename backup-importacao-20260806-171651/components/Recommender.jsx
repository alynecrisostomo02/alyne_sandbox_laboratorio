...
export default function Recommender({ favorites, onFavorite }) {
  ...
  const questions = [
    ...
    {
      key: "gated",
      title: "Prefere condomínio fechado?",
      hint: "Isso ajuda a priorizar o tipo de localização.",
      options: [["yes", "Sim, é importante"], ["no", "Não é necessário"], ["any", "Tanto faz"]],
    },
    {
      key: "features",
  ...
  const result = useMemo(() => {
    ...
    const scored = properties
      ...
      .map((property) => {
        ...
        const isGated = property.type === "condominio" || property.features.includes("Condomínio fechado");
